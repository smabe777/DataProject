...
public class DataProjectApplication {
	...
	CommandLineRunner runner(ApplicationContext ctx) {
		return args -> {
			...
			/*
			 * Person person = new Person ("123456", "Bill", "Boket"); Day day1= new Day(new
			 * Date()); day1.Set_birthday(true);
			 * 
			 * 
			 * Day day2= new Day(new Date()); day2.Set_holiday(true);
			 * day2.setPerson(person);
			 * 
			 * person.print(); dbservice.save(person); dbservice.save(day1);;
			 */
